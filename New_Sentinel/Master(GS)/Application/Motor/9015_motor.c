...
/* Private variables -----------------------------------------------------------*/
/*9015电机pid计算结构体*/
pid_t                  motor_9015_pid_bmi_spd;
pid_t                  motor_9015_pid_bmi_pos;

pid_t                  motor_9015_pid_enc_pos;
pid_t                  motor_9015_pid_enc_spd;
...
{
	/*PID初始化*/
	PID_struct_init( &motor_9015_pid_bmi_spd,POSITION_PID,S_PIT_LIM_O,S_PIT_LIM_I,S_PIT_PID_P,S_PIT_PID_I,S_PIT_PID_D);
	PID_struct_init( &motor_9015_pid_enc_pos,POSITION_PID,P_PIT_LIM_O,P_PIT_LIM_I,P_PIT_PID_P,P_PIT_PID_I,P_PIT_PID_D);
	PID_struct_init( &motor_9015_pid_bmi_pos,POSITION_PID,B_PIT_LIM_O,B_PIT_LIM_I,B_PIT_PID_P,B_PIT_PID_I,B_PIT_PID_D);
	PID_struct_init( &motor_9015_pid_enc_spd,POSITION_PID,Y_PIT_LIM_O,Y_PIT_LIM_I,Y_PIT_PID_P,Y_PIT_PID_I,Y_PIT_PID_D);
...
void Motor_9015_Speed()
{
	...
	motor_9015_structure.base_info->target_iq    = pid_calc(&motor_9015_pid_bmi_spd,\
...
void Motor_9015_Position()
{
	/*陀螺仪数据*/
	motor_9015_structure.base_info->speed = bmi_structure.yaw_gro;
	
	motor_9015_structure.base_info->target_speed    = pid_calc_err_9015(&motor_9015_pid_enc_pos,\
														        motor_9015_structure.base_info->encoder,\
														        motor_9015_structure.base_info->target_angle);
	
	motor_9015_structure.base_info->target_iq    = pid_calc(&motor_9015_pid_enc_spd,\
														       motor_9015_structure.base_info->speed,\
														        motor_9015_structure.base_info->target_speed);
...
void Motor_9015_BmiPosition()
{
	...
	motor_9015_structure.base_info->target_speed    = pid_calc_err(&motor_9015_pid_bmi_pos,\
														        yaw_angle,\
