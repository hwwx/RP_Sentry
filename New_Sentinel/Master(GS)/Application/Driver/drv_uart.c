...
static void dma_m0_rxcplt_callback(DMA_HandleTypeDef *hdma)
{
	...
	rc_base_info_update(rc_structure.base_info,usart2_dma_rxbuf[0]);
	rc_structure.info->offline_cnt = 0;
}
...
/**
 *	@brief	[__WEAK] 需要在Potocol Layer中实现具体的 USART33 处理协议
 */
__WEAK void USART3_rxDataHandler(uint8_t *rxBuf)
{	
}
