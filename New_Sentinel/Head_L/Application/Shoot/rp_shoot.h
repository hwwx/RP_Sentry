...
#define DEAL_DONE_SPEED      	  (1000)
#define SHOOT_DONE_SPEED_MAX   	  (100)
#define SIX_SHOOT_DONE_TIME_MAX   (700)
...
#define DEAL_DONE_ROUND_TIME   	  (900) //堵转处理时间
#define DEAL_DONE_ROUND_HALF_TIME (450) 


/*摩擦轮速度环*/
#define PID_FIRC_OUTPUT_MAX    9000
#define PID_FIRC_INTEGRA_MAX   500  // 500
#define PID_FIRC_KP            20
#define PID_FIRC_KI            0.01 // 0.01
