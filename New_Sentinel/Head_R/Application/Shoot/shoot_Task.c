...
{		
		...
		if(Master_Head_structure.R_Head_status.status == DEV_ONLINE)
		{
			...
			{
				shoot_structure.base.firct_speed = -(5800 + Master_Head_structure.Send_R_Head.shoot_mode*10);
		...
		//shoot_structure.base.firct_speed = -1000;
		//shoot_structure.base.firct_speed = -(5800 + 100*10);
