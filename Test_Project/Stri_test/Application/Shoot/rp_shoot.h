...
#define SIX_SHOOT_DONE_TIME_MAX   (100)
...
/*堵转的时候不检测堵转？*/
/*记得和堵转角度一起调*/
#define DEAL_DONE_ROUND_TIME   	  (100) //堵转处理时间
#define DEAL_DONE_ROUND_HALF_TIME (50) 
...
#define SPID_STRI_INTEGRA_MAX   9800
#define SPID_STRI_KP            10
#define SPID_STRI_KI            0.20   //0.01
#define SPID_STRI_KD            0

/*位置*/
#define PPID_STRI_OUTPUT_MAX    8000 //8000
#define PPID_STRI_INTEGRA_MAX   1000 
#define PPID_STRI_KP            0.35
#define PPID_STRI_KI            0
#define PPID_STRI_KD            0

/*连发波胆轮速度环*/
#define TPID_STRI_OUTPUT_MAX    9800
#define TPID_STRI_INTEGRA_MAX   4000
