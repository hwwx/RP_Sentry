...
extern shoot_data_t shoot_statistics;
char ch1[22] = {0};
char ch2[22] = {0};
void OledTask(void)
{
...
//		sprintf(ch1, "Mea: %d",judge.data->power_heat_data.chassis_power);
//		sprintf(ch2, "Var: %3.5f",shoot_statistics.variance);
//		
//		OLED_ShowString(0, 0, (uint8_t *)ch1, 22);
//		OLED_ShowString(0, 1, (uint8_t *)ch2, 22);
