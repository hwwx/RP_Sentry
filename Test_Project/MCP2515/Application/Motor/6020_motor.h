...
HAL_StatusTypeDef MOTOR_6020_CAN1_SENT_DATA( int16_t data_1,int16_t data_2,int16_t data_3,int16_t data_4);
HAL_StatusTypeDef MOTOR_6020_CAN2_SENT_DATA( int16_t data_1,int16_t data_2,int16_t data_3,int16_t data_4);
