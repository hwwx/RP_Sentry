...
bool CANSPI_Initialize(void)
{
  ...
  * tbit = 1tq                + 2tq      + 3tq + 2tq   = 8tq
  * 8tq  = 1us = 1000kbps
  */
  
  /* 00(SJW 1tq) 000000(brp(0)) */ 
  MCP2515_WriteByte(MCP2515_CNF1, 0x00); //0x2A
  
  /* 1 0 010(PS1 2+1tq) 001(PROP_SEG 1+1tq) */   
  MCP2515_WriteByte(MCP2515_CNF2, 0x91); //0x29
  
  /* 1 0 000 001(PS2 1+1tq) */
  MCP2515_WriteByte(MCP2515_CNF3, 0x81); //0x28
