...
#define CAN_CS_Pin CAN_CS_GPIO_Port_Pin
#define CAN_CS_GPIO_Port CAN_CS_GPIO_Port_GPIO_Port
...
{
#if DAM_SPI
  HAL_SPI_Transmit_DMA(SPI_CAN, &data, 1);
#else
...
{
#if DAM_SPI
  HAL_SPI_Transmit_DMA(SPI_CAN, buffer, length);
#else
...
static uint8_t SPI_Rx(void)
{
  ...
  uint8_t retVal;
#if DAM_SPI
  HAL_SPI_Receive_DMA(SPI_CAN, &retVal, 1);
#else
...
{
#if DAM_SPI
  HAL_SPI_Receive_DMA(SPI_CAN, buffer, length);
#else
